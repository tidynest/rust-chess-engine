...
// Depth 5 is slow  ->  Run with:     cargo test -- --ignored
#[test]
#[ignore]
...
// =============================================================================
// Kiwipete Position - Stress test for move generation
...
#[test]
fn perft_position_4() {
    // Position 4 from chessprogramming wiki
...
#[test]
fn perft_position_5() {
    // Position 5: Tests en passant and promotions
    let board =
...
// =============================================================================
// Helper function to print perft results (for debugging)
// =============================================================================
